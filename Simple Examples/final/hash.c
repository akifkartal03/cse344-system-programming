...
void hash_insert(hash_table_ptr tbl, element_type2 e)
{
    pos pos = tbl->hfunc(e);
...
pos hash_find(hash_table_ptr tbl, element_type2 e)
{
    int i = 0;
    pos idx = tbl->hfunc(e);
...
void hash_delete(hash_table_ptr ptr, element_type2 e)
{
    pos pos = hash_find(ptr, e);
    if (pos != -1) {
